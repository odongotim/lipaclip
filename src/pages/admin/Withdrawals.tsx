  ...
  return (
    <div className="min-h-screen bg-[#0f0a06] flex">
      ...
      <main className="lg:ml-64 flex-1 p-6 pt-16 lg:pt-8">
        ...
        <p className="text-gray-400 text-sm mb-6">Monitor Pesapal payments (auto-verified) and process withdrawals</p>
              ...
              <div key={dep.id} className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-4">
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  <div className="flex-1">
                    ...
                    <div className="text-yellow-400 text-xs mt-1 font-mono">Ref: {dep.pesapal_merchant_reference}</div>
