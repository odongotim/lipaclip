                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-16 h-16 rounded-xl bg-yellow-500/20 flex items-center justify-center flex-shrink-0 overflow-hidden">
                    {camp.thumbnail_url
                      ...
                      : <svg className="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.55-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.45.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                    }
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {camp.platforms && (
                      <div className="flex gap-1 mb-1">
                        {camp.platforms.map(p => <span key={p} className="text-[10px] uppercase tracking-wide bg-yellow-500/10 text-yellow-400 px-1.5 py-0.5 rounded">{PLATFORM_LABELS[p] || p}</span>)}
                      </div>
                    )}
            ...
            <div key={idx} className="bg-black/20 rounded-lg p-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex gap-3 text-xs">
                  <span className="text-blue-400">{inf.totalViews.toLocaleString()} views</span>
